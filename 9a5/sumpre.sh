...
while [ $MDCURRENTJOB -le 100 ]; do
	let MDINPUT="$MDCURRENTJOB -1"
        /share/home/yanglj/amber14/bin/pmemd.MPI -O -i NVT_entropy.in -o $filename\_$MDCURRENTJOB.out -p $filename.parm7 -c $filename\_$MDINPUT.rst7  -r $filename\_$MDCURRENTJOB.rst7 -x $filename\_$MDCURRENTJOB.nc -ref $filename\_$MDINPUT.rst7
