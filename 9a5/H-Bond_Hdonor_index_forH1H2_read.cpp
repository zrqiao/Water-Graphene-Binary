...
int main() {
    ...
    while (!infile.fail()) {
        ...
        for (int frame_r=frame_r_st;frame_r<frame_r_ed&&frame_r<1000000;frame_r+=dt) {
            ...
            if (Direction==1) {
                outfile01 << jump_id << std::setw(10) << Target_ID << std::setw(10) << nc << std::setw(10) << frame
                          << std::setw(10);
                get_HB_id1 = -1;
                get_HB_id2 = -1;
                ...
                outfile01 << get_HB_id1 << std::setw(10) << get_HB_id2 << std::setw(10) << std::endl;
            }
            else if (Direction==-1) {
                outfile02 << jump_id << std::setw(10) << Target_ID << std::setw(10) << nc << std::setw(10) << frame
                          << std::setw(10);
                get_HB_id1 = -1;
                get_HB_id2 = -1;
                for (index j = 0; j != select_wat_id.size(); ++j) {
                ...
                outfile02 << get_HB_id1 << std::setw(10) << get_HB_id2 << std::setw(10) << std::endl;
            }
        }
