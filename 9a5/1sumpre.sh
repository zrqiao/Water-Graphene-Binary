...
export filename="water_graphene_15a5"
...
while [ $MDCURRENTJOB -le 10 ]; do
	let MDINPUT="$MDCURRENTJOB -1"
        /share/home/yanglj/amber14/bin/pmemd.MPI -O -i NVT.in -o $filename\_$MDCURRENTJOB.out -p $filename.parm7 -c $filename\_$MDINPUT.rst7  -r $filename\_$MDCURRENTJOB.rst7 -x $filename\_$MDCURRENTJOB.nc -ref $filename\_$MDINPUT.rst7
