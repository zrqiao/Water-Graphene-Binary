...
int main()
{
    ...
    for(int frame = 0; frame < 10000; frame += 100)
    {
		++sum_frame;
        ...
        sprintf(name_2, "/media/cxx/disk3/data_water_in_graphene/280k/9a5/enthaply/222/wat_c_9a5_%d.rst7",frame);
         ...
         outfile2<<nc_data.atoms_number()-3*num_wat<<std::endl;
         //~ std::cout<<nc_data.atoms_number()<<"  "<<num_wat<<" "<< nc_data.atoms_number()-3*num_wat<<std::endl;
